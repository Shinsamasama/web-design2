$(function(){
    ...
    $(window).scroll(function() {
      ...
      let gallery_position = $('#section2').offset().top - $(window).height();
      // 画面下から#accessまでの距離を取得
      let access_position = $('#section3').offset().top - $(window).height();
      ...
      let contact_position = $('#section4').offset().top - $(window).height();
